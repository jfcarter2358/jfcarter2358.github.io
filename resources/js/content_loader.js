var pageContent = {
        ...
        "blocks" : 
        {
            ...
            "b1" : 
            {
                ...
                [
                    ...
                    "Leveraged machine learning algorithms to perform analysis on the data and provide insight into correlations with external events and factors"
                ]
            }
        }
    },
    ...
    "uiuc":
    {
        ...
        "blocks" :
        {
            ...
            "b1" :
            {
                "title" : "Astronomy Courses",
                "content" :
                [
                    "<div><p style='font-family:monospace;display:inline;'>ASTR 210 --&nbsp;</p>Introduction to Astrophysics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>ASTR 404 --&nbsp;</p>Stellar Astrophysics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>ASTR 414 --&nbsp;</p>Astronomical Techniques</div>",
                    "<div><p style='font-family:monospace;display:inline;'>ASTR 496 --&nbsp;</p>Seminar in Astronomy</div>",
            ...
            "b2" : 
            {
                ...
                [
                    ...
                    "<div><p style='font-family:monospace;display:inline;'>INFO 490 --&nbsp;</p>Introduction to Data Science</div>",
                ]
            },
            "b3" :
            {
                "title" : "Linguistics Courses",
                "content" :
                [
            ...
            "b4" : 
            {
                ...
                [
                    ...
                    "<div><p style='font-family:monospace;display:inline;'>MATH 285 --&nbsp;</p>Differential Equations</div>",
                    "<div><p style='font-family:monospace;display:inline;'>MATH 402 --&nbsp;</p>Non-Euclidean Geometry</div>",
            ...
            "b5" : 
            {
                ...
                [
                    ...
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 212 --&nbsp;</p>University Physics: Electricity and Magnetism</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 213 --&nbsp;</p>University Physics: Thermal Physics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 214 --&nbsp;</p>University Physics: Quantum Mechanics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 225 --&nbsp;</p>Relativity and Math Applications</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 325 --&nbsp;</p>Classical Mechanics I</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 401 --&nbsp;</p>Classical Physics Lab</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 403 --&nbsp;</p>Modern Experimental Physics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 427 --&nbsp;</p>Thermal and Statistical Physics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 435 --&nbsp;</p>Electromagnetic Fields I</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 475 --&nbsp;</p>Introduction to Biophysics</div>",
                    "<div><p style='font-family:monospace;display:inline;'>PHYS 486 --&nbsp;</p>Quantum Physics I</div>",
                ]
            }
        }
    }
...
$(document).ready(
    function()
    {
        ...
        for (var b in pageContent[pageName]["blocks"])
        {
            // add in section title as header
            content += "<h4>" + pageContent[pageName]["blocks"][b]["title"] + "</h4>";
            // create section content list and populate it
            content += "<ul>";
            for (var c in pageContent[pageName]["blocks"][b]["content"])
            {
                content += "<li>" + pageContent[pageName]["blocks"][b]["content"][c] + "</li>";
            }
            content += "</ul>";
        ...
        // populate content and title elements with data
        contentTitle.innerHTML = "<h3>" + pageContent[pageName]["title"] + "</h3>";
